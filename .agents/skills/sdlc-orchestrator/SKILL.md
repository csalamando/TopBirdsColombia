...
harness-owns: "spec/authority-matrix.yaml, spec/team-roster.yaml, spec/risk-tier.yaml, spec/dashboard.html, spec/pipeline-state.md, spec/METRICS.md, spec/metrics/, spec/reports/"
