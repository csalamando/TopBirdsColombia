...
harness-phases: "2, 3"
harness-owns: "spec/architecture.md, spec/api-contract.yaml, spec/data-model.md, spec/adr/, spec/test-plan.md, spec/tech-debt.md, spec/diagrams/contenedores.ir.json, spec/diagrams/secuencia-ronda.ir.json, spec/diagrams/flujo-datos.ir.json"
