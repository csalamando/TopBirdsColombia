...
**What**: Sprint review 17 generado (spec/reports/sprint-review-17.md) con METRICS.md embebido: 45 activaciones, 42 recibos, gates al primer intento 100% salvo product-owner (75%, 1 rechazo). Cobertura por fases OK en 0/2/4/6; fases 3/5/-1 sin actividad registrada en el periodo; product-owner aparece como adorno en fases 1 y 7 (se activo sin producir artefacto con recibo).
